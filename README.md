...
이 프로젝트는 사용자가 자신의 하루나 감정에 대한 짧은 글을 작성하면, AI가 그 내용을 분석하여 사용자의 감정 상태를 파악하고, 그에 맞는 따뜻한 위로와 격려의 문장을 추천해주는 웹 애플리케이션입니다.

## 2. 주요 목표

**성찰의 시간 제공** : 잠시나마 자신의 마음을 들여다보고, 따뜻한 위로를 받으며 긍정적인 하루를 마무리할 수 있도록 돕습니다.
