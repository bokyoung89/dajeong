...
- **Frontend:** React, Vite, JavaScript (ES6+), CSS (모던 UI 컴포넌트를 활용한 반응형 사용자 인터페이스 구현
)
- **Backend:** Python, Flask (경량 웹 프레임워크로 API 엔드포인트 및 비즈니스 로직 구현)
- **Database & Auth:** Supabase, PostgreSQL (안전한 인증 시스템 및 관계형 데이터베이스 활용)
- **AI:** Large Language Model (LLM) API (대규모 언어 모델을 활용한 감정 분석 및 문장 추천)
- **Version Control:** Git
...
- **모바일 애플리케이션 개발**
  - 모바일 앱으로 확장하여 언제 어디서나 사용자의 감정을 기록하고 위로받을 수 있게 접근성을 높일 예정입니다.
...
- **위로문장 DB 자동화 및 확장**
  - 양질의 문장을 자동으로 수집하고 분류하는 시스템 구축으로 더 다양하고 적절한 위로 메시지 제공 능력을 향상시킬  계획입니다.